"""
Django settings for reviews_book project.
...
SECRET_KEY = 'django-insecure-p!4@)#g+ltm^=y24#1ke93)c1(jq^3ibqu$jms&c&t3akdlt2$'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['review_book_test_2.onrender.com']
